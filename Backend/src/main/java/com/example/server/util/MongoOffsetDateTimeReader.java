...
import static com.example.server.util.MongoOffsetDateTimeWriter.DATE_FIELD;
import static com.example.server.util.MongoOffsetDateTimeWriter.OFFSET_FIELD;
